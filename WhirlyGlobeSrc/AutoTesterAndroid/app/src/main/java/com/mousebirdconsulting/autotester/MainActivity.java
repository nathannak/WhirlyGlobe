...
public class MainActivity extends AppCompatActivity implements NavigationDrawer.Listener {
	...
	//de-register location listener
	@Override
	protected void onStop() {
		super.onStop();

		if ( AndroidLocationTestCase.mGoogleApiClient != null &&  AndroidLocationTestCase.mGoogleApiClient.isConnected()) {
			AndroidLocationTestCase.mGoogleApiClient.disconnect();
		}
	}
	//
}
