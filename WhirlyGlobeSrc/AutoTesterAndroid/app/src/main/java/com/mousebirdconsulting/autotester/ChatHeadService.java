...
import com.mousebirdconsulting.autotester.TestCases.AndroidLocationTestCase;

public class ChatHeadService extends Service {
    private WindowManager windowManager;
    private RelativeLayout chatheadView, removeView;
    private LinearLayout txtView, txt_linearlayout;
    private ImageView chatheadImg, removeImg, fake_location;
    ...
    private void handleStart(){
        ...
        fake_location = (ImageView)chatheadView.findViewById(R.id.engage_fake_location);
        //
        chatheadImg.setTag(R.drawable.nolock);    //When you change the drawable
        //
        AndroidLocationTestCase.headingUp = false;
        AndroidLocationTestCase.northUp = false;
        //
        chatheadImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //Toast.makeText(view.getContext(),""+ chatheadImg.getTag(),Toast.LENGTH_LONG).show();

                if(chatheadImg.getTag().equals(2130837868))
                {
                    //
                    chatheadImg.setImageResource(R.drawable.northup);
                    chatheadImg.setTag(R.drawable.northup);

                    //
                    AndroidLocationTestCase.headingUp = false;
                    AndroidLocationTestCase.northUp = true;
                    //

                    //
                }else if(chatheadImg.getTag().equals(2130837869))
                {
                    //
                    chatheadImg.setImageResource(R.drawable.headingup);
                    chatheadImg.setTag(R.drawable.headingup);
                    //
                    AndroidLocationTestCase.headingUp = true;
                    AndroidLocationTestCase.northUp = false;
                    //

                    //
                }else if(chatheadImg.getTag().equals(2130837668))
                {
                    //
                    chatheadImg.setImageResource(R.drawable.nolock);
                    chatheadImg.setTag(R.drawable.nolock);
                    //
                    AndroidLocationTestCase.headingUp = false;
                    AndroidLocationTestCase.northUp = false;
                    //
        ...
        //
        fake_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //
                Toast.makeText(view.getContext(), "engaging fake locations", Toast.LENGTH_SHORT).show();
                //
                AndroidLocationTestCase.engageFakeLocation = true;
                //
            }
            });
        //
