...
class ImageryPro_QuadImageLayerAdapter : public QuadDataStructure, public QuadTileImageDataSource, public QuadDisplayControllerAdapter
{
public:
	...
	ImageryPro_QuadImageLayerAdapter(CoordSystem *coordSys)
	...
	virtual ~ImageryPro_QuadImageLayerAdapter()
	{
	}
